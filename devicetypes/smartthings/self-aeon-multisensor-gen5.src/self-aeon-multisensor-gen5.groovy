 ...
 */
metadata {
	definition (name: "SELF: Aeon Multisensor Gen5", namespace: "smartthings", author: "SmartThings") {
...
def configureAfterSecure() {
    ...
    def request = [
		...
		zwave.configurationV1.configurationSet(parameterNumber: 3, size: 2, scaledConfigurationValue: 10),
		...
		zwave.notificationV3.notificationSet(notificationType: 7, notificationStatus: 1),
